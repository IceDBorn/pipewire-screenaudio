...
### Audio pitching
> Note: You can fix this issue by switching to another microphone and then switching back to your selection. Also, a mozilla employee posted a [WIP build](https://bugzilla.mozilla.org/show_bug.cgi?id=1844181#c17) of Firefox that fixes this issue
